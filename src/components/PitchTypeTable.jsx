...
const columns = [
  ...
  { title: metricTitle('# RHB'), dataIndex: 'rhb', sorter: (a, b) => (a.rhb || 0) - (b.rhb || 0), width: 74, render: numericCell, ...right },
  { title: metricTitle('# LHB'), dataIndex: 'lhb', sorter: (a, b) => (a.lhb || 0) - (b.lhb || 0), width: 74, render: numericCell, ...right },
