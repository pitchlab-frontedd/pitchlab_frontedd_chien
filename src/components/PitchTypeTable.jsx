...
const METRIC_HELP = {
  ...
  'vs RHB': 'Pitches to right-handed batters. RHB means right-handed batter, not pitcher hand.',
  'vs LHB': 'Pitches to left-handed batters. LHB means left-handed batter, not pitcher hand.',
